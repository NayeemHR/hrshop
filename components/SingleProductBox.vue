  ...
  <div class="single-bs-product">
    <div class="h-80 relative mb-6">
      ...
      <div class="product-img-hover absolute h-full w-full top-0 left-0 flex justify-center items-center">
        ...
        <nuxt-link class="absolute left-0 bottom-0 bg-gray-200 p-2 w-full flex items-center justify-center" to="/">Details</nuxt-link>
    ...
    <p><span class="font-medium hs-dark-orange-color">$200</span> <del class="text-gray-400">$500</del></p>
  </div>
</template>
